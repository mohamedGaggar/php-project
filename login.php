...
<html lang="en">
  ...
  <body>
<h1 style="color:orange;margin-left:40px;margin-top:30px">Login Now🍪</h1>
...
<form>
  ...
  <button type="submit" class="btn btn-primary" style="margin-top:50px;margin-left:50px;width:150px" name="loginBtn">Submit</button>
</form>
